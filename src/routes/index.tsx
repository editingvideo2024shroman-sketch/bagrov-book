...
const CHAPTERS: {
...
}[] = [
  {
    ...
    blurb: "Тяжесть в голове, дефицит энергии, сонливость по утрам, потеря концентрации в течение дня.",
    count: "24 рецепта",
    Icon: Zap,
  },
  {
    ...
    blurb: "Первые симптомы простуды, озноб и слабость, кашель, быстрое восстановление сил.",
    count: "20 рецептов",
    Icon: Shield,
  },
  {
    ...
    blurb: "Вздутие, тяжесть и распирание живота, дискомфорт после плотной еды.",
    count: "22 рецепта",
    Icon: Apple,
  },
  {
    ...
    blurb: "Редкий и нерегулярный стул, дискомфорт в животе, мягкое восстановление баланса.",
    count: "10 рецептов",
    Icon: Wheat,
  },
  {
    ...
    blurb: "Жжение после еды, раздражённый желудок, дискомфорт по ночам.",
    count: "10 рецептов",
    Icon: Droplets,
  },
  {
    ...
    blurb: "Скачки давления, холестерин, тяжесть и напряжение в теле.",
    count: "21 рецепт",
    Icon: HeartPulse,
  },
  {
    roman: "VII",
    title: "Суставы и усталость ног",
    blurb: "Ноют колени, поясница и косточка на ноге, вечерние отёки и тяжесть, которая не даёт уснуть. Компрессы, растирания и ванночки для облегчения к утру.",
    count: "17 рецептов",
    Icon: Sprout,
  },
  {
    ...
    blurb: "Тусклый тон, выпадение волос, шелушение и стянутость кожи.",
    count: "16 рецептов",
    Icon: Sparkles,
  },
  {
    roman: "IX",
    title: "Тревога и сон",
    blurb: "Паника, фоновая тревога, выгорание, трудности с засыпанием.",
    count: "10 практик",
    Icon: Brain,
  },
];
  ...
  return (
    <div className="min-h-svh bg-paper pb-24">
      <div className="bg-ink px-4 py-3 text-center">
        <a
          href="/timofey-bagrov-kniga.pdf"
          download="timofey-bagrov-kniga.pdf"
          ...
          <div>
            ...
            <div className="mt-3 space-y-2 font-serif text-sm leading-relaxed text-ink-soft sm:text-base">
              ...
              <p>
                ...
                километров от цивилизации и аптек. Возрождаю и тестирую на себе
                методы наших дедов, вместо таблеток. Снимаю всё на видео —
                некоторые ролики посмотрели больше миллиона человек.
              </p>
              <p>Делюсь тем, что реально работает.</p>
              <p>
                Бонусом в конце справочника — 6 коротких записей на случай, если
                тебе сейчас тяжело. Не болейте, друзья!
              </p>
            </div>
            <a
