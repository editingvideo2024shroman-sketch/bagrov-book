        ...
        <div className="mt-8 space-y-8 font-serif text-base leading-relaxed text-ink-soft">
          <section>
            ...
            <p className="mt-3">
              ...
              Шаминым Романом Александровичем (далее — Оператор).
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-3">
              <span className="font-sans text-sm font-semibold tracking-wide text-muted uppercase">
                Цель обработки
              </span>
              <br />
              оформление и обработка заказов; предоставление доступа к
              электронному справочнику; отправка ссылки на скачивание; направление
              чеков и подтверждений оплаты.
            </p>
            <p className="mt-3">
              <span className="font-sans text-sm font-semibold tracking-wide text-muted uppercase">
                Персональные данные
            ...
            <ul className="mt-1 list-disc pl-5">
              <li>
                согласие Пользователя; исполнение договора купли-продажи
                цифрового продукта; требования законодательства РФ.
              </li>
            </ul>
            <p className="mt-3">
              <span className="font-sans text-sm font-semibold tracking-wide text-muted uppercase">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              Оператора vikramodin@gmail.com с пометкой «Актуализация
              персональных данных».
            </p>
            <p className="mt-3">
            ...
            <p className="mt-3">
              ...
              vikramodin@gmail.com с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
            <p className="mt-3">
              ...
              Политикой конфиденциальности. Оператор не несет ответственность за
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a
                className="text-clay"
                href="https://www.timofey-bagrov.ru/privacy"
              >
                https://www.timofey-bagrov.ru/privacy
              </a>
              .
            </p>
          </section>
